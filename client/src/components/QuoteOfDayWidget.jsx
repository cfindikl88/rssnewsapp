...
// Quotes array defined outside component to maintain stable reference
const QUOTES = [
...
// Helper function to get quote for day
...
const QuoteOfDayWidget = () => {
    // Initialize state directly with today's quote
    const [quoteData, setQuoteData] = useState(getQuoteForDay);

    // Memoize getQuoteForDay to avoid recreation on every render
    const getQuote = useMemo(() => getQuoteForDay, []);
...
export default QuoteOfDayWidget;
